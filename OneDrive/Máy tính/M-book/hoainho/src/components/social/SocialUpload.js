    ...
    return (
        <div className="social__upload">
            ...
            <div className="social__upload-content">
                <textarea onClick={() => setRows(6)} rows={rows} className="social__upload-content-input" placeholder="Nguyên ơi ,Bạn đang nghĩ gì vậy ?..." required="" data-expandable autocomplete="off"></textarea>
