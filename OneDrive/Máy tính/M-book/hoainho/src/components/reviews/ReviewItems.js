...
import imgdetails from './book1.jpg';
import imgAfter from './book1.jpg';
            ...
            <div className='bodyStoreItem'>
                <div className="bodyStoreItem__tagSale reviewItem__tag">
                    ...
                    <div className="bodyStoreItem__tagSale--sale">
                        <span className={classname("bodyStoreItem__tagSale--sale-wrap ", { "bodyStoreItem__tagSale--sale-wrap-grid ": gridTab !== 0 })}>
                            TOP 1
                    </span>
                    </div>
                </div>
