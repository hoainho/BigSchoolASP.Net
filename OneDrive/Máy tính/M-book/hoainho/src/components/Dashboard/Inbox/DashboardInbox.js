                    ...
                    {sortDateChat.length > 0 &&
                        sortDateChat.map((item, index) => {
                            ...
                            return (
                                ...
                                >
                                    <div className="boxchat-avt flex-center-dashboard" style={{ pointerEvents: 'none' }}>
                                        {item.userInfo &&
                                            <img
                    ...
                    <div className="boxchat-mobile-header flex">
                        ...
                        {sortDateChat.length > 0 &&
                            <div className="boxchat-box-info">
                                <div className="boxchat-box-avt flex-center-dashboard">
                                                ...
                                                <div
                                                    ...
                                                    className="chat-list">
                                                    {
                                                        ...
                                                        >
                                                            ...
                                                            {openTimeTooltip === item.time &&
                                                                <div className="time-tooltip-client flex-center-dashboard">
                                                                    <p>{chatTime}</p>
                                                                </div>
                                                            }
                                                        </div>
                                                    }
                                                    {
                                                        ...
                                                        >
                                                            ...
                                                            {openTimeTooltip === item.time &&
                                                                <div className="time-tooltip flex-center-dashboard">
                                                                    <p>{chatTime}</p>
                                                                </div>
                                                            }
                                                        </div>
